...
def export_QuantNeg(cursor, Unique_ID:int, Title:str,
                         Context:str, Match:str, Link:str, Clauses:int, Date:str, Standalone:str):

    cursor.execute('''INSERT INTO QuantNeg VALUES(?,?,?,?,?,?,?,?)''', (Unique_ID, Title,
                         Context, Match, Link, Clauses, Date, Standalone))
